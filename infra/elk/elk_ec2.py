...
# Default instance type for both master and slave
...
def parse_args():
    ...
    parser.add_option(
        "--master-user-data", type="string", default="user_data/kibana.sh",
        help="Path to a user-data file for master (most AMIs interpret this as an initialization script)")
    parser.add_option(
        "--slave-user-data", type="string", default="user_data/elastic.sh",
        help="Path to a user-data file for slaves (most AMIs interpret this as an initialization script)")
    parser.add_option(
