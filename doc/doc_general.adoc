...
Data is syncronized daily by batches and they are stored under s3://gerepo/.
...
This is the network topology which give us any information about network elements. 
