...
----
include::{sourcedir}/collect/serverconsumption/conf/conf.sh[lines=4..5]
----
...
----
include::{sourcedir}/collect/serverconsumption/conf/server.lst[lines=1..5]
...
----
...
----
include::{sourcedir}/collect/serverconsumption/bin/collect.sh[lines=16..21]
----

=== Convert XLS to CSV

Once we collected all XLS files we convert them to CSV format one by one.

[source,bash]
.collect/serverconsumption/bin/convert-send.sh
----
include::{sourcedir}/collect/serverconsumption/bin/convert-send.sh[lines=10..20]
----
